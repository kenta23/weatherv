...
export default function WeeklyForecast ({ coord } : { coord: Coord }) {
 ...
 return (
   <div className='flex w-full overflow-x-auto gap-3 overflow-y-hidden scrollbar-hide'>
           ...
           <div className="flex w-full opacity-100 flex-col items-center gap-3">
             ...
             <div className='space-y-3 flex flex-col items-center'>
                 ...
                 <div className='flex flex-col items-center'>
                      ...
                      <p className='text-md md:text-xl -mt-2 font-medium'>{item.main.temp} °C</p>
                 </div>


                 <div className='text-[10px] md:text-sm items-center gap-1 flex flex-col'>
                     {/**LOW AND HIGH TEMP */}
